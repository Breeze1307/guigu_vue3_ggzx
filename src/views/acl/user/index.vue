...
<template>
  <el-card>
    <el-form :inline="true" class="form">
      ...
      <el-form-item>
        <el-button type="primary" @click="search" :disabled="searchName?false:true">搜索</el-button>
  ...
  <el-card style="margin-top: 10px;">
    ...
    <el-table :data="userInfo" border style="margin: 10px 0;">
      ...
      <el-table-column label="操作" width="300px" align="center">
        <template #="{ row }">
          <el-button type="primary" icon="User" size="small" @click="assignRole">
            分配角色
          </el-button>
  ...
  >
    <template #default>
      <el-form :model="userParams" :rules="userRules" ref="userRef">
        ...
        </el-form-item><el-form-item label="用户密码" prop="password" v-show="!userParams.id">
...
const getUserList = async (page = 1) => {
  pageNo.value=page
  let result: UserInfoList = await reqUserList(pageNo.value, limit.value,searchName.value)
  if (result.code == 200) {
